...
export default function RaceDetail() {
    ...
    const horses = [
      { number: 1, name: 'ソリッドスフィア', rate: '70.31%', flag: 0 },
      { number: 2, name: 'ガイ', rate: '70.31%', flag: 0 },
      { number: 3, name: 'オストラヴァ', rate: '70.31%', flag: 0 },
      { number: 4, name: 'テンペストーソ', rate: '85.14%', flag: 0 },
      { number: 5, name: 'ダイタエリュシオン', rate: '85.14%', flag: 0 },
      { number: 6, name: 'キョウキランブ', rate: '85.14%', flag: 0 },
      { number: 7, name: 'フィーチャリング', rate: '85.14%', flag: 0 },
      { number: 8, name: 'ノイシュタット', rate: '85.14%', flag: 0 },
      { number: 9, name: 'テルケンレングレー', rate: '71.37%', flag: 0 },
      { number: 10, name: 'リアルショット', rate: '85.78%', flag: 1 },
      { number: 11, name: 'ミスレモン', rate: '86.37%', flag: 1 },
      { number: 12, name: 'ヴェネチアンレース', rate: '86.37%', flag: 1 },
      { number: 13, name: 'ラブリーウィザード', rate: '75.06%', flag: 0 },
      { number: 14, name: 'ハシリマッセ', rate: '75.06%', flag: 0 },
      { number: 15, name: 'バギーウィップ', rate: '84.07%', flag: 0 },
      { number: 16, name: 'ラントレイル', rate: '75.06%', flag: 0 },
    ]
