...
export default function RaceDetail() {
    ...
    const horses = [
      { number: 1, name: 'ニヒトツーゼーア', rate: '85.14%', flag: 1 },
      { number: 2, name: 'ハッピールンナ', rate: '85.14%', flag: 1 },
      { number: 3, name: 'イージーゴーイング', rate: '85.14%', flag: 1 },
      { number: 4, name: 'カガセブンスター', rate: '70.31%', flag: 0 },
      { number: 5, name: 'ムーンナイト', rate: '86.37%', flag: 1 },
      { number: 6, name: 'メルキオル', rate: '86.37%', flag: 1 },
      { number: 7, name: 'サンライズフーガ', rate: '75.06%', flag: 0 },
      { number: 8, name: 'アカイツメ', rate: '73.73%', flag: 0 },
    ]
