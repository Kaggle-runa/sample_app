...
export default function RaceDetail() {
    ...
    const horses = [
      { number: 1, name: 'ノワナ', rate: '70.31%', flag: 0 },
      { number: 2, name: 'スーパーチャンド', rate: '70.31%', flag: 0 },
      { number: 3, name: 'ドラゴンガール', rate: '85.14%', flag: 1 },
      { number: 4, name: 'ハリウッドメモリー', rate: '70.31%', flag: 0 },
      { number: 5, name: 'ニシノイツキムスメ', rate: '70.31%', flag: 0 },
      { number: 6, name: 'アメリータ', rate: '70.31%', flag: 0 },
      { number: 7, name: 'カルミアクラウン', rate: '70.31%', flag: 0 },
      { number: 8, name: 'アスターシッキム', rate: '85.78%', flag: 1 },
      { number: 9, name: 'ギザキズラヴ', rate: '69.92%', flag: 0 },
      { number: 10, name: 'ランフォースマイル', rate: '71.37%', flag: 0 },
      { number: 11, name: 'ウォーターガーベラ', rate: '71.37%', flag: 0 },
      { number: 12, name: 'インナモラート', rate: '83.40%', flag: 1 },
      { number: 13, name: 'セレーネアステール', rate: '75.06%', flag: 0 },
      { number: 14, name: 'サーリアル', rate: '75.06%', flag: 0 },
      { number: 15, name: 'エイプリルインパリ', rate: '73.73%', flag: 0 },
    ]
