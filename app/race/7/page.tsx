...
export default function RaceDetail() {
    ...
    const horses = [
      { number: 1, name: 'ニホンピロゴルディ', rate: '70.31%', flag: 0 },
      { number: 2, name: 'オイデレオ', rate: '85.14%', flag: 0 },
      { number: 3, name: 'ワンパット', rate: '85.14%', flag: 0 },
      { number: 4, name: 'ハットリ', rate: '85.14%', flag: 0 },
      { number: 5, name: 'ラミアストラーダ', rate: '85.14%', flag: 0 },
      { number: 6, name: 'レーヴドレフォン', rate: '84.91%', flag: 0 },
      { number: 7, name: 'ジュンラトゥール', rate: '85.78%', flag: 1 },
      { number: 8, name: 'ディズレーリ', rate: '86.37%', flag: 1 },
      { number: 9, name: 'アスターチェンチ', rate: '86.37%', flag: 1 },
      { number: 10, name: 'メイショウマジック', rate: '84.07%', flag: 0 },
      { number: 11, name: 'ベファーナ', rate: '84.07%', flag: 0 },
      { number: 12, name: 'ピカレスクノベル', rate: '84.07%', flag: 0 },
      { number: 13, name: 'エアフォースワン', rate: '83.40%', flag: 0 },
    ]
