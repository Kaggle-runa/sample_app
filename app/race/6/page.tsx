...
export default function RaceDetail() {
    ...
    const horses = [
      { number: 1, name: 'ランニングホット', rate: '70.31%', flag: 0 },
      { number: 2, name: 'ノーティチェリー', rate: '70.31%', flag: 0 },
      { number: 3, name: 'ベストヒューマ', rate: '70.31%', flag: 0 },
      { number: 4, name: 'コムーネ', rate: '70.31%', flag: 0 },
      { number: 5, name: 'ラトルシェ', rate: '70.31%', flag: 0 },
      { number: 6, name: 'オカゲサン', rate: '85.14%', flag: 1 },
      { number: 7, name: 'テイオームサシ', rate: '86.37%', flag: 1 },
      { number: 8, name: 'リケアコンパンナ', rate: '71.37%', flag: 0 },
      { number: 9, name: 'シュラフ', rate: '71.37%', flag: 0 },
      { number: 10, name: 'メモリーフィルム', rate: '71.37%', flag: 0 },
      { number: 11, name: 'コンスピラシー', rate: '75.06%', flag: 0 },
      { number: 12, name: 'ナックカイザー', rate: '75.06%', flag: 0 },
      { number: 13, name: 'キープサインオン', rate: '83.40%', flag: 1 },
      { number: 14, name: 'ヴェロニカペルシカ', rate: '75.06%', flag: 0 },
    ]
